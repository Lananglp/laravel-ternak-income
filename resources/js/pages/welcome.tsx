...
const CardPricing = ({ label, price, priceDuration, description, features }: CardPricingProps) => {
    return (
        <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
            <div className='h-full p-4 sm:p-6 xl:p-8 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                ...
                <div className='flex-none'>
                    <button type="button" className="bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Choose plan</button>
                </div>
            </div>
        </div>
    )
    ...
    return (
        <>
            ...
            <div className="relative">
                ...
                <header className='mb-4 px-4 py-3 static top-0 z-20 bg-neutral-950/30 backdrop-blur-sm border-b border-neutral-900'>
                    <div className='max-w-screen-xl mx-auto flex justify-between items-center gap-2'>
                        <Link href={route('home')}>
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">{appName}</h1>
                            </div>
                        </Link>
                        <nav className="flex items-center justify-end gap-4">
                            {auth.user ? (
                                ...
                                <>
                                    <Link
                                        href='#'
                                        className="inline-block rounded-full px-4 py-1.5 text-sm leading-normal font-medium bg-gradient-to-r from-red-700 to-orange-700 text-white"
                                    >
                ...
                <main className='pt-6 sm:pt-12 xl:pt-16'>
                    <section>
                        <div className='relative max-w-screen-xl mx-auto'>
                            <div className='absolute top-0 end-1/2 opacity-15 h-64 w-64 bg-linear-0 bg-orange-500 blur-[6rem] rounded-full pointer-events-none'></div>
                            <div className='absolute top-36 start-0 opacity-15 h-48 w-48 bg-linear-0 bg-orange-500 blur-[6rem] rounded-full pointer-events-none'></div>
                            <div className='absolute bottom-0 start-1/2 opacity-20 h-28 w-28 bg-linear-0 bg-orange-500 blur-[6rem] rounded-full pointer-events-none'></div>

                            <div className='relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-12 px-4 sm:px-8'>
                                <div className='lg:col-span-6 space-y-8'>
                                    <h2 className="max-w-sm sm:max-w-2xl text-3xl lg:text-5xl tracking-tight leading-snug font-semibold text-neutral-900 dark:text-white">Bagaimana Cara Saya Menghasilkan <span className='text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500'>Rp1 Miliar</span> dengan Menjual Produk Digital Pakai ChatGPT</h2>
                                    <p className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 font-semibold sm:text-xl sm:leading-8">Serap ilmu teknis membuat dan menjual digital produk 10 juta+ per bulan yang saya terapkan.</p>
                                    <Link href="#pricing" className='hidden lg:inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-8 py-3 text-xl font-medium'><CrownIcon className='inline h-6 w-6 me-2 mb-1' />Gabung Sekarang</Link>
                                </div>
                                <div className='lg:col-span-6'>
                                    <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-2xl ps-[1px] pt-[1px]'>
                                        <iframe className='bg-black aspect-video w-full rounded-2xl border border-neutral-900/50' src="https://www.youtube.com/embed/7vDA6MFWVeI?si=bAgkxh1Cwlt8kX9I" title="YouTube video player" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='max-w-3xl mx-auto relative lg:hidden flex justify-center items-center gap-4 sm:gap-8 py-12'>
                                ...
                                <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-8 py-3 text-xl font-medium'><CrownIcon className='inline h-6 w-6 me-2 mb-1' />Gabung Sekarang</Link>
                                <div className='w-32 h-[1px] bg-neutral-900' />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className='mb-20 max-w-screen-xl mx-auto px-4 sm:px-8'>
                        <div className="mb-8 lg:mb-16 text-center">
                            <h2 className="mb-4 text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Untuk siapa ini?</h2>
                        </div>

                        <div>
                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-8 xl:p-12 bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        <div className='mb-2 inline-block bg-neutral-950 text-orange-500 rounded-full p-3'>
                                            <ChartLineIcon className='h-7 w-7' />
                                        </div>
                                        {/* <h6 className='font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500'>pemula serius / orang awam</h6> */}
                                ...
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-8 xl:p-12 bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        ...
                                        {/* <h6 className='font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500'>Kreator Konten yang Ingin Naik Kelas</h6> */}
                                ...
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-8 xl:p-12 bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        ...
                                        {/* <h6 className='font-bold text-3xl text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500'>Pendidik Digital & Ahli di Bidangnya</h6> */}
                    ...
                    <section className='relative z-10'>
                        <div className='bg-gradient-to-r from-red-600 to-orange-600'>
                            <div className='max-w-screen-md px-4 py-8 mx-auto text-center lg:py-24 lg:px-6'>
                                <h2 className="text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Siap untuk melihat hasil seperti ini?</h2>
                        ...
                        <div className='py-12 max-w-screen-xl mx-auto grid grid-cols-3 gap-4'>
                            <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                <div className='h-full p-4 bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                        ...
                        <div className='bg-gradient-to-r from-red-600 to-orange-600'>
                            <div className="max-w-screen-md mx-auto text-center py-20">
                                <h2 className="mb-8 text-4xl tracking-tight leading-snug font-semibold text-white">Jual Produk Digitalmu Sekarang, <br /> Mulai dalam Hitungan Menit!</h2>
                                <Link
                                    href='#'
                                    className="inline-block rounded-full px-6 py-3 text-xl leading-normal font-medium bg-neutral-950 text-white"
                                >
                    ...
                    <section>
                        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                            <div className="max-w-screen-md mx-auto mb-8 lg:mb-16 text-center">
                                <h2 className="mb-4 text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Video testimoni</h2>
                    ...
                    <section className='mb-12 max-w-screen-xl mx-auto px-4 sm:px-8'>
                        <div className="mb-8 lg:mb-16 text-center">
                            <h2 className="mb-4 text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Apa yang kamu dapatkan?</h2>
                        ...
                        <div>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-6 xl:p-12 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        <div className='flex-grow'>
                                            <div className='mb-4 inline-block bg-neutral-950 text-orange-500 rounded-full p-3'>
                                                <SparklesIcon className='h-7 w-7' />
                                            </div>
                                            <h6 className='mb-0 font-bold text-3xl text-white'>Akses semua ilmu sistematis</h6>
                                            <p className='mb-6 text-lg leading-8 text-orange-300'>( modul video 20 lebih )</p>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-6 py-1 text-xl font-semibold'>Rp. 1.000.000</Link>
                                            <p>/ Bulan</p>
                                        </div>
                                    </div>
                                </div>
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-6 xl:p-12 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        <div className='flex-grow'>
                                            ...
                                            <h6 className='mb-4 font-bold text-3xl text-white'>Live mentoring QNA session pakai zoom</h6>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-6 py-1 text-xl font-semibold'>Rp. 500.000</Link>
                                            <p>/ Bulan</p>
                                        </div>
                                    </div>
                                </div>
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-6 xl:p-12 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        <div className='flex-grow'>
                                            ...
                                            <h6 className='mb-4 font-bold text-3xl text-white'>Research, Trend & Study Case</h6>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-6 py-1 text-xl font-semibold'>Rp. 250.000</Link>
                                            <p>/ Bulan</p>
                                        </div>
                                    </div>
                                </div>
                                <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                    <div className='h-full p-4 sm:p-6 xl:p-12 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black'>
                                        <div className='flex-grow'>
                                            ...
                                            <h6 className='mb-4 font-bold text-3xl text-white'>Akses grup premium</h6>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-6 py-1 text-xl font-semibold'>Rp. 600.000</Link>
                                            <p>/ Bulan</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section>
                        <div className='max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6'>
                            <h2 className="mb-20 text-3xl md:text-5xl tracking-tight leading-snug font-semibold text-white text-center">
                                Jika ditotal, seluruh benefit eksklusif ini bernilai <br /> lebih dari <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">Rp. 2.350.000</span>
                            </h2>
                            <div className='bg-gradient-to-br from-orange-500 to-transparent to-50% rounded-xl ps-[1px] pt-[1px]'>
                                <div className='h-full p-4 sm:p-6 xl:p-12 flex flex-col bg-neutral-950/85 rounded-xl shadow-2xl shadow-black space-y-8'>
                                    <h2 className="text-3xl md:text-4xl leading-snug font-semibold text-white">
                                        Tapi khusus perdana launching <br /> kami berikan mulai <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">Rp. 299.000</span> untuk akses belajar <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">1 bulan penuh</span>
                                    </h2>
                                    ...
                                    <h2 className="text-3xl md:text-4xl leading-snug font-semibold text-white">
                                        Paket kedua <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">Rp. 399.000</span> untuk akses belajar <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">3 bulan penuh</span>
                                    </h2>
                                    <div className='flex items-center gap-8'>
                                        <div className='w-32 h-[1px] border-b border-neutral-600' />
                                        <div className='text-xl'>atau</div>
                                    ...
                                    <h2 className="mb-8 text-3xl md:text-4xl leading-snug font-semibold text-white">
                                        Langsung pilih paket terbaik <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">Rp. 600.000</span> untuk akses <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">seumur hidup</span> tanpa biaya bulanan!
                                    </h2>
                                    <div className='flex flex-col md:flex-row gap-2'>
                                        <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-8 py-2.5 text-xl font-semibold'>Beli 1 bulan</Link>
                                        <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-8 py-2.5 text-xl font-semibold'>Beli 3 bulan</Link>
                                        <Link href="#pricing" className='inline-block text-nowrap bg-gradient-to-r from-red-700 to-orange-700 hover:from-red-600 hover:to-orange-600 text-white rounded-full px-8 py-2.5 text-xl font-semibold'>Beli selamanya</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section>
                        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                            <div className="max-w-screen-md mx-auto mb-8 lg:mb-16 text-center">
                                <h2 className="mb-4 text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</h2>
                                <p className="text-neutral-500 sm:text-xl dark:text-neutral-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit voluptatibus molestias accusantium vero perspiciatis ut!</p>
                            </div>
                            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-4 md:space-y-0">
                                <div className='border border-neutral-800 rounded-lg'>
                                    <img src="https://images.pexels.com/photos/1595385/pexels-photo-1595385.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="background" className='aspect-video w-full object-cover rounded-t-lg' />
                                    <div className='p-4'>
                                        ...
                                        <p className="text-neutral-500 dark:text-neutral-400"><span className='mr-2 px-2.5 py-0.5 rounded bg-gradient-to-r from-red-700 to-orange-700 text-white'>16 Lessons</span> 2h 30m</p>
                                    </div>
                                </div>
                                <div className='border border-neutral-800 rounded-lg'>
                                    <img src="https://images.pexels.com/photos/1595385/pexels-photo-1595385.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="background" className='aspect-video w-full object-cover rounded-t-lg' />
                    ...
                    <section className='bg-gradient-to-r from-red-600 to-orange-600 p-6'>
                        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    ...
                    <div className="max-w-screen-md mx-auto mb-8 lg:mb-16 text-center">
                        <h2 className="mb-4 text-4xl tracking-tight font-semibold text-neutral-900 dark:text-white">Testimoni Member Ternak Income</h2>
