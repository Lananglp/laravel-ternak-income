      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            // "group/sidebar-wrapper has-data-[variant=inset]:bg-orange-500/5 flex min-h-svh w-full",
            className
          )}
          {...props}
        >
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "bg-background md:border md:border-neutral-800 relative flex max-w-full min-h-svh flex-1 flex-col",
        // "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0",
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(8)))] md:peer-data-[variant=inset]:m-4 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0",
        className
      )}
      {...props}
    />
